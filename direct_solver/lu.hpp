...
class AMD_LU : public IExternalSolver <TAlgebra>,
    public AMD_Solver {
public:
    ...
    [[nodiscard]] const char * double_name() const override {  return "AMD_LU"; };
...
template <typename TAlgebra>
void AMD_LU<TAlgebra>::double_init(const matrix_t &mat){
    solver_.Clear();
...
template <typename TAlgebra>
bool AMD_LU<TAlgebra>::double_apply(vector_t &c, const vector_t &d){
